        ...
        <div className="min-h-screen flex items-center justify-center px-4 bg-surface-950 relative overflow-hidden">
            ...
            <div className="w-full max-w-md animate-fade-in z-10">
                ...
                <div className="text-center mb-8">
                    ...
                    <h1 className="text-2xl font-bold text-surface-50 tracking-tight mb-2">Welcome back</h1>
                ...
                <div className="bg-surface-900/50 backdrop-blur-xl border border-surface-800 rounded-2xl p-8 shadow-2xl">
                    <form onSubmit={handleSubmit} className="space-y-5">
                        {message && (
                            <div className="bg-emerald-500/10 border border-emerald-500/20 text-emerald-400 px-4 py-3 rounded-lg text-xs font-medium animate-slide-up flex items-center gap-2">
